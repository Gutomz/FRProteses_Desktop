...
part 'customer_edit_page_store.g.dart';

class CustomerEditPageStore = _CustomerEditPageStoreBase
    with _$CustomerEditPageStore;

abstract class _CustomerEditPageStoreBase with Store {
  ...
  Future<CustomerEntity?> saveForm() async {
    ...
    final savedModel = await customerStore.set(formData);

    return savedModel;
  }

  CustomerEntity convertFormData() {
