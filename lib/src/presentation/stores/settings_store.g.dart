...
mixin _$SettingsStore on _SettingsStoreBase, Store {
  ...
  bool get hasError =>
      (_$hasErrorComputed ??= Computed<bool>(() => super.hasError,
              name: '_SettingsStoreBase.hasError'))
          .value;
  ...
  final _$_errorMessageAtom = Atom(name: '_SettingsStoreBase._errorMessage');
  ...
  final _$_loadingAtom = Atom(name: '_SettingsStoreBase._loading');
  ...
  final _$clearAsyncAction = AsyncAction('_SettingsStoreBase.clear');
  ...
  void _setErrorMessage(Failure? failure) {
    final _$actionInfo = _$_SettingsStoreBaseActionController.startAction(
        name: '_SettingsStoreBase._setErrorMessage');
    try {
  ...
  void _startLoading() {
    final _$actionInfo = _$_SettingsStoreBaseActionController.startAction(
        name: '_SettingsStoreBase._startLoading');
    try {
  ...
  void _stopLoading() {
    final _$actionInfo = _$_SettingsStoreBaseActionController.startAction(
        name: '_SettingsStoreBase._stopLoading');
    try {
